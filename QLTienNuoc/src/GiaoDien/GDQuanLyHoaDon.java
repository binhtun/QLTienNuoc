...
public class GDQuanLyHoaDon extends javax.swing.JFrame {
    ...
    public GDQuanLyHoaDon() {
        initComponents();
        String header[] ={"Mã HD","Họ Tên","Mã KH","Khối Nước", "Tiền"};
    ...
    private void showData(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            try {
                ...
                hd.setKhoiNuoc(rs.getFloat("khoiNuoc"));
                hd.setThanhTien(rs.getFloat("tien"));
    ...
    private void getDataDB() {
        ...
        try {
            String sql = "select HOADON.maKH, hoTen, maHD, khoiNuoc, tien from HOADON join HOTIEUTHU on HOADON.maKH = HOTIEUTHU.maKH";
    ...
    private void ThemBangThanhToan(int i) {
        ...
        try {
            ...
            String sql = "select  hoTen, mathang,khoiNuoc, tien from HOADON join HOTIEUTHU on HOADON.maKH = HOTIEUTHU.maKH join CHISONUOC on CHISONUOC.maKH = HOADON.maKH where HOADON.maKH = ?";
            dbConnect=new DBConnect();
            connection=dbConnect.connect();
            PreparedStatement ps = connection.prepareStatement(sql);
            ps.setString(1, maKH);
            ...
            while (rs.next()) {
                ...
                txtTien.setText("" + rs.getFloat("tien"));
                txtThang.setText(rs.getString("mathang"));
                txtLDTT.setText("" + rs.getFloat("khoiNuoc"));
            }
        } catch (SQLException ex) {
            Logger.getLogger(GDQuanLyHoaDon.class.getName()).log(Level.SEVERE, null, ex);
        } 
    ...
    private void initComponents() {
        ...
        tbHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã khách hàng", "Họ tên khách hàng", "Mã hóa đơn", "Khối nước sử dụng", "Tiền"
            }
        ));
        ...
        jLabel17.setText("Số Lượng Nước Tiêu Thụ: ");
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        public void actionPerformed(ActionEvent ae) {
                try {
                    ...
                    String sql = "select HOADON.maKH, hoTen, maHD, khoiNuoc, tien from HOADON join HOTIEUTHU on HOADON.maKH = HOTIEUTHU.maKH where HOADON.maKH+HoaDon.maHD+hoTen like ?";
                    dbConnect=new DBConnect();
                    connection=dbConnect.connect();
                    PreparedStatement ps = connection.prepareStatement(sql);
                    ps.setString(1, "%" + maKH + "%");
