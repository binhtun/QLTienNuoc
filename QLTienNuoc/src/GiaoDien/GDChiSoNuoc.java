 ...
 */
package GiaoDien;
import ControllerGD.ChiSoNuocController;
...
public class GDChiSoNuoc extends javax.swing.JFrame {
    ...
    public ChiSoNuoc getDataFromResultSet(ResultSet rs) {
        ChiSoNuoc capNhatChiSoDien = null;
        try {
            String maKH = rs.getString("maKH");
            String maThang = rs.getString("maThang");
            String chiSoMoi = rs.getString("chiSoMoi");
            String chiSoCu = rs.getString("chiSoCu");
            capNhatChiSoDien = new ChiSoNuoc(maKH, maThang, Integer.parseInt(chiSoCu), Integer.parseInt(chiSoMoi));
    ...
    public void getDataFromDB() {
        try {
            ...
            String sqlQuery = "Select * from CHISONUOC";
            PreparedStatement ps = connection.prepareStatement(sqlQuery);
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                ChiSoNuoc model = getDataFromResultSet(rs);
    ...
    private void createDemo(String maKh, String mathang) {
        try {
            ...
            Logger.getLogger(ChiSoNuocController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    private void createHD() {
        try {
            String sql = "select maKH, maThang from CHISONUOC \n"
...
//    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Quản lý chỉ số nước");
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        try {
            ...
            ChiSoNuocController chiSoDienCT=new ChiSoNuocController();
        ...
        if (txtMaKH.getText().isEmpty() || txtMaThang.getText().isEmpty() || txtChiSoCu.getText().isEmpty() || txtChiSoMoi.getText().isEmpty()) {
            ...
            try {
                ...
                if (csm < csc) {
                    ...
                    ChiSoNuoc csd1= new ChiSoNuoc(txtMaKH.getText(), txtMaThang.getText(), csc, csm);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GDChiSoNuoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GDChiSoNuoc().setVisible(true);
            }
        });
    }
